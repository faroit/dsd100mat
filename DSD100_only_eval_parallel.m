...
estimates_name = 'EstimatesKAM_fast'; %here provide the name of the directory to eval
base_directory = pwd;
parpool('local')
warning('off','all')
...
for subset_index = 1:2
    ...
    estimates_folder = fullfile(base_directory,estimates_name,subsets_names{subset_index});
